...
Config.Stores = {
	...
	[23] = {shopType = 'clothing', coords = vector3(1885.89, 3806.67, 33.32), width = 2, length = 2}
}
...
Config.ClothingRooms = {
    [1] = {requiredJob = 'police', isGang = false, coords = vector3(462.61, -996.49, 30.69), width = 2, length = 2, cameraLocation = vector4(454.42, -990.52, 30.69, 358.48)},
    [2] = {requiredJob = 'ambulance', isGang = false, coords = vector3(316.08, -589.41, 43.29), width = 2, length = 2, cameraLocation = vector4(342.47, -586.15, 43.32, 342.56)},
    [3] = {requiredJob = "realestate", isGang = false, coords = vector3(-711.79, 270.79, 83.11), width = 2, length = 2, cameraLocation = vector4(-131.45, -633.74, 168.82,  2.18)}
}
